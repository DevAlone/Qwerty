...
"}"));
    ...
    {
        DrawingTabForm->setWindowTitle(QApplication::translate("DrawingTabForm", "MainWindow", Q_NULLPTR));
        labelImage->setText(QApplication::translate("DrawingTabForm", "Image will be here", Q_NULLPTR));
        pushButton_2->setText(QApplication::translate("DrawingTabForm", "PushButton", Q_NULLPTR));
        toolbar->setWindowTitle(QApplication::translate("DrawingTabForm", "too&lbar", Q_NULLPTR));
        pushButton->setText(QApplication::translate("DrawingTabForm", "PushButton", Q_NULLPTR));
        toolButton->setText(QApplication::translate("DrawingTabForm", "...", Q_NULLPTR));
        toolButton_2->setText(QApplication::translate("DrawingTabForm", "...", Q_NULLPTR));
    } // retranslateUi
